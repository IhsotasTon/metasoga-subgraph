...
import {
  ...
  UpdateOracle,
  UpdatePaymentToken
} from "../generated/MetasogaMarketPlace/MetasogaMarketPlace"
...
export function handleNftWhitelistAdd(event: NftWhitelistAdd): void {}

export function handleNftWhitelistRemove(event: NftWhitelistRemove): void {}
